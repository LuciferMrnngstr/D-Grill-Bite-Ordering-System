...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2023 at 06:05 AM
...
(8, 'Coke Mismo', '25.00', 'Cold bottle coke', 'IMG-6460426ad8b3a9.39940666.png', 'unavailable', 0, 0, 0, '2023-05-14 02:07:38', '2023-06-01 01:05:13'),
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=311;
...
--
ALTER TABLE `notification`
  MODIFY `notif_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=184;
