<?php
    ...
    if(isset($_POST['save_new'])){
        ...
        if($notification->addEditDeleteDish($_SESSION['user_type'], $_SESSION['user_id'], $_SESSION['logged_in'], $food_id, 'delete dish')){ //Create notification
            if($foods->delete($food_id)){
                $dm = $food['name'] . ' deleted successfully!';
                header('location: store.php?delete=' . $dm);
            }
        }
    }
?>
