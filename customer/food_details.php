<?php
    ...
    if(isset($_POST['submit']) && $data['availability'] !== 'unavailable'){
        ...
        if($cart->checkDuplicate($user_id, $food_id)[0] > 0){
            $cart->updateQuantity2($user_id, $food_id, $quantity);
        }
        else {
        ...
        if($_POST['submit'] === 'Buy now'){
            ...
            header('location: home.php?sm=Item added to cart.');
        }
    }
...
<div class="wrapper">
    ...
    <section class="food_details">
        ...
        <div class="buttons">
            <?php
                if($data['availability'] === 'unavailable'){
                    echo '<button class="unavailable">Item unavailable</button>';
                }
                else{
        ...
        <form class="modal-box input-description" method="post">
            ...
            <div class="desc-container">
                ...
                <div class="input-quantity">
                    ...
                    <input type="number" id="quantity" name="quantity" value="1" oninput="checkRange(this)">
        ...
        <span class="error">Quantity must be between 1 and 10</span>
    </section>
</div>
