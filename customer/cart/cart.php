<?php
    ...
    if($carts->checkEmpty($customer_id)){
        $row = $carts->checkEmpty($customer_id);
    }
...
?>
        ...
        <div class="content empty">
            ...
            <a href="../home/home.php" class="btn-round">Browse</a>
        </div>        
...
<?php
                foreach($carts->render($customer_id) as $cart){
                    ...
                    if(isset($_POST['submit'])){
                        $order->addOrder($customer_id, $cart['food_product_id'], $cart['quantity']);
                    }
?>
