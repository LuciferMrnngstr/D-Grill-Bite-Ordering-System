...
?>
    <a href="../admin/login/logout.php" class="btn-round">Admin</a>
    <a href="../customer/login/logout.php" class="btn-round">Customer</a>
    <a href="../vendor/login/logout.php" class="btn-round">Vendors</a>
    <a href="../cashier/login/logout.php" class="btn-round">Cashier</a>
</div>
