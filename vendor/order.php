...
<div class="wrapper">
    <?php
        include_once '../includes/vendor/topnav.php'; //Top navbar
    ?>
...
<section class="order">
        ...
        <div class="order-container">
            <?php
                ...
                if($orderClass->renderStatus($_SESSION['user_id'], $_SESSION['user_type']) === 'empty') {
                    echo '<div class="empty"><h1>No pending or to be prepare orders as of now.</h1></div>';
                }
                else if($show_all === false){
                    foreach($orderClass->renderStatus($_SESSION['user_id'], $_SESSION['user_type']) as $status){
