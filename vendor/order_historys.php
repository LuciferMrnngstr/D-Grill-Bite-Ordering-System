        ...
        ?>
                <div class="order-container">
                    <div class="item-wrappers">
                        ...
                        ?>
                                    <a href="order_info.php?customer_id=<?= $order['user_id'] ?>&order_id=<?= $order['order_id'] ?>&status=<?= $order['order_status'] ?>" class="items <?= $status['order_status'] . ' ' .  $order['payment_status']?>">
