<?php
    ...
    class Cart{
        ...
        function checkEmpty($customer_id){
            if($customer_id == 'NULL'){
                $sql = 'SELECT COUNT(*) AS row FROM cart WHERE customer_id IS NULL;';
            }
            else{
                $sql = 'SELECT COUNT(*) AS row FROM cart WHERE customer_id = :customer_id;';
            }
        ...
        function render($customer_id){
            if($customer_id == 'NULL'){
                $sql = 'SELECT cart.customer_id, cart.cart_id, cart.food_product_id, cart.created_at, food_product.img, food_product.name, cart.quantity, 
